const withPWA = require("next-pwa")({
  ...
  additionalManifestEntries: [
    ...
    { url: "/S2/calendar", revision: "v1.0.1" },
    { url: "/S2/Calendar/academic_calendar_2026.jpg", revision: "v1.0.1" },
    { url: "/S2/Calendar/routine2ndsem.png", revision: "v1.0.1" },
    ...
    { url: "/S2/eee", revision: "v1.0.1" },
    { url: "/S2/eee/EeeFinal", revision: "v1.0.0" },
    { url: "/S2/eee/EeeLab", revision: "v1.0.1" },
    ...
    { url: "/S2/bs", revision: "v1.0.1" },
    { url: "/S2/bs/BsMid", revision: "v1.0.0" },
    { url: "/S2/bs/BsMid/bs_geo_features.pdf", revision: "v1.0.1" },
    { url: "/S2/bs/BsMid/bs_janapada.pdf", revision: "v1.0.1" },
    { url: "/S2/bs/BsMid/shashanka_full_notes.pdf", revision: "v1.0.1" },
