...
const EeeLabEx1 = () => {
  // Function to handle alternating row colors and hover
  const rowClass = (idx) =>
    `transition-colors ${
  ...
  return (
    <div className="space-y-12 p-6 flex flex-col items-center">
      {/* Table 1 */}
        ...
        <table className="marks-table border-collapse w-full text-center shadow-lg rounded-lg overflow-hidden">
          <thead className="bg-blue-600 text-white">
            ...
            <tr>
              ...
              <th className="px-4 py-2">R<sub>T</sub> total resistance</th>
              <th className="px-4 py-2">I</th>
              <th className="px-4 py-2">V<sub>ab</sub></th>
              <th className="px-4 py-2">V<sub>cd</sub></th>
              <th className="px-4 py-2">R<sub>T</sub></th>
              <th className="px-4 py-2">I</th>
              <th className="px-4 py-2">V<sub>ab</sub></th>
              <th className="px-4 py-2">V<sub>cd</sub></th>
            </tr>
